...
function uc_user_register($username, $password, $email,$phonenum, $questionid = '', $answer = '', $regip = '') {
	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>$username, 'password'=>$password, 'email'=>$email,'phonenum'=>$phonenum, 'questionid'=>$questionid, 'answer'=>$answer, 'regip' => $regip));
}
...
function uc_user_checkphone($phonenum) {
	return call_user_func(UC_API_FUNC, 'user', 'check_phonenum', array('phonenum'=>$phonenum));
}
