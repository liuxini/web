...
class RegisterController extends HomeBaseController {
	...
	function doregister(){
    	...
    	$users_model=M("Users");
		$phone=$phonenum;
		$temp = "select * from sp_userfind where phonenum=$phone";
		$result = $users_model->query($temp); 
		if($result){
			$this->error("手机号已经存在！");
		}
