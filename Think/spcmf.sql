...
CREATE TABLE `sp_helper` (
  `helperid` bigint(15) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sp_reservation` (
  ...
  `userphone` int(15) NOT NULL DEFAULT '0',
  `message` text,
  PRIMARY KEY (`reserid`),
  KEY `pay` (`pay`),
  KEY `address` (`address`),
...
INSERT INTO `sp_auth_rule` VALUES ('25', 'Portal', 'admin_url', 'portal/adminsq/index', null, '申请管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('27', 'Portal', 'admin_url', 'portal/adminsq/delete', null, '删除页面', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('28', 'Portal', 'admin_url', 'portal/adminsq/edit', null, '编辑页面', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('29', 'Portal', 'admin_url', 'portal/adminsq/edit_post', null, '提交编辑', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('30', 'Portal', 'admin_url', 'portal/adminsq/add', null, '添加页面', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('31', 'Portal', 'admin_url', 'portal/adminsq/add_post', null, '提交添加', '1', '');
...
INSERT INTO `sp_auth_rule` VALUES ('87','Portal','admin_url','portal/adminreservation/index',NULL,'预约申请',1,''),
INSERT INTO `sp_auth_rule` VALUES ('89', 'Portal', 'admin_url', 'portal/adminreservation/delete', null, '删除预约', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('90', 'Portal', 'admin_url', 'portal/adminreservation/edit', null, '编辑预约', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('91', 'Portal', 'admin_url', 'portal/adminreservation/edit_post', null, '提交编辑', '1', '');


INSERT INTO `sp_auth_rule` VALUES ('100', 'Portal', 'admin_url', 'portal/adminservicerecord/index', null, '订单列表', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('101', 'Portal', 'admin_url', 'portal/adminservicerecord/add', null, '添加订单', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('102', 'Portal', 'admin_url', 'portal/adminservicerecord/add_post', null, '提交添加', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('105', 'Portal', 'admin_url', 'portal/adminservicerecord/edit', null, '编辑订单', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('106', 'Portal', 'admin_url', 'portal/adminservicerecord/edit_post', null, '提交编辑', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('107', 'Portal', 'admin_url', 'portal/adminservicerecord/delete', null, '删除菜单', '1', '');
...
INSERT INTO `sp_menu` VALUES ('7', '1', 'Portal', 'AdminPost', 'index', '', '1', '1', '阿姨管理', '', '', '1');
INSERT INTO `sp_menu` VALUES ('10', '7', 'Portal', 'AdminPost', 'recommend', '', '1', '0', '阿姨推荐', '', '', '0');
INSERT INTO `sp_menu` VALUES ('13', '7', 'Portal', 'AdminPost', 'delete', '', '1', '0', '删除阿姨', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('14', '7', 'Portal', 'AdminPost', 'edit', '', '1', '0', '修改阿姨信息', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('15', '14', 'Portal', 'AdminPost', 'edit_post', '', '1', '0', '提交编辑', '', '', '0');
INSERT INTO `sp_menu` VALUES ('16', '7', 'Portal', 'AdminPost', 'add', '', '1', '0', '添加阿姨', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('17', '16', 'Portal', 'AdminPost', 'add_post', '', '1', '0', '提交添加', '', '', '0');

INSERT INTO `sp_menu` VALUES ('18', '1', 'Portal', 'AdminBroker', 'index', '', '0', '1', '经纪人管理', '', '', '2');
INSERT INTO `sp_menu` VALUES ('19', '18', 'Portal', 'AdminBroker', 'recommend', '', '1', '0', '经纪人推荐', '', '', '0');
INSERT INTO `sp_menu` VALUES ('20', '18', 'Portal', 'AdminBroker', 'delete', '', '1', '0', '删除经纪人', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('21', '18', 'Portal', 'AdminBroker', 'edit', '', '1', '0', '修改经纪人信息', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('22', '21', 'Portal', 'AdminBroker', 'edit_post', '', '1', '0', '提交编辑', '', '', '0');
INSERT INTO `sp_menu` VALUES ('23', '18', 'Portal', 'AdminBroker', 'add', '', '1', '0', '添加经纪人', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('24', '23', 'Portal', 'AdminBroker', 'add_post', '', '1', '0', '提交添加', '', '', '0');

INSERT INTO `sp_menu` VALUES ('25', '1', 'Portal', 'AdminSq', 'index', '', '1', '1', '工作申请管理', '', '', '3');
INSERT INTO `sp_menu` VALUES ('27', '25', 'Portal', 'AdminSq', 'delete', '', '1', '0', '删除页面', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('28', '25', 'Portal', 'AdminSq', 'edit', '', '1', '0', '编辑页面', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('29', '28', 'Portal', 'AdminSq', 'edit_post', '', '1', '0', '提交编辑', '', '', '0');
INSERT INTO `sp_menu` VALUES ('30', '25', 'Portal', 'AdminSq', 'add', '', '1', '0', '添加页面', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('31', '30', 'Portal', 'AdminSq', 'add_post', '', '1', '0', '提交添加', '', '', '0');
...
INSERT INTO `sp_menu` VALUES ('36', '32', 'Portal', 'AdminSq', 'recyclebin', '', '1', '1', '申请回收', '', '', '1');
INSERT INTO `sp_menu` VALUES ('37', '36', 'Portal', 'AdminSq', 'clean', '', '1', '0', '彻底删除', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('38', '36', 'Portal', 'AdminSq', 'restore', '', '1', '0', '申请恢复', '', '', '1000');
...
INSERT INTO `sp_menu` VALUES ('90', '85', 'Portal', 'AdminServicerecord', 'index', '', '1', '1', '订单', '', '', '0');
INSERT INTO `sp_menu` VALUES ('101', '90', 'Portal', 'AdminServicerecord', 'add', '', '1', '0', '添加订单', '', '', '0');
INSERT INTO `sp_menu` VALUES ('102', '101', 'Portal', 'AdminServicerecord', 'add_post', '', '1', '0', '提交添加', '', '', '0');
INSERT INTO `sp_menu` VALUES ('105', '90', 'Portal', 'AdminServicerecord', 'edit', '', '1', '0', '编辑订单', '', '', '1000');
INSERT INTO `sp_menu` VALUES ('106', '105', 'Portal', 'AdminServicerecord', 'edit_post', '', '1', '0', '提交编辑', '', '', '0');
INSERT INTO `sp_menu` VALUES ('107', '90', 'Portal', 'AdminServicerecord', 'delete', '', '1', '0', '删除订单', '', '', '1000');
