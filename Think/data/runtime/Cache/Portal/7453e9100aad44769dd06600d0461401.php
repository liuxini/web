...
<div class="property-filter widget box-shadow-1">
    <div class="content">
        <form id="select" method="post" action="<?php echo u('list/sortrelist');?>">
            <div class="location control-group">
                <label class="control-label" for="inputLocation">
                     	类型
                </label>
                <div class="controls">
                    <select name="type" id="type" value="<?php echo ($formget["type"]); ?>">
